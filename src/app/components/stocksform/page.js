...
export default function Stockform() {
  ...
  return (
    <div className="flex flex-col items-center w-full  ">
      ...
      >
        ...
        <div className=" relative top-0 box-border h-14 overflow-visible w-2/3 flex flex-col-3 justify-center bg-zinc-800 text-white p-2 rounded-md border-2 border-zinc-500 mt-2 mb-2">
          <div className="flex flex-col-2">
            ...
            <input
              className="bg-zinc-200 w-[100%] relative text-black rounded-md border-2 border-zinc-700  hover:border-zinc-1000 p-1"
              type="number"
              step={1}
              name="kerf"
              id="kerf"
        ...
        <div className="relative w-full">
          {stockInputs.map((stockInput, index) => (
            ...
            >
              <div className="flex w-16 h-14 justify-center text-center text-[30px] pt-1 bg-zinc-800 text-zinc-300 rounded-md border-2 border-zinc-500 m-2">
                {index + 1}
              </div>
              {stockInput}
              <button
      ...
      <button
        className="relative top-[-20px] bg-zinc-600 active:bg-zinc-400 p-3 rounded-md border-2 border-zinc-200 z-10"
