                ...
                <div className="w-full p-2 pt-0 pb-0">
                  <div className=" relative w-full flex felx-col-2">
                    ...
                    <div className=" relative flex text-[20px] font-extrabold">
                      {totalUsedStocks}{" "}
                      <span className="text-zinc-300 font-normal">pcs</span>
                    </div>
                  </div>
                  <div className="w-full h-[3px] bg-zinc-700"></div>
            ...
            if (value != 0) {
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full h-[3px] bg-zinc-700 mt-4 mb-2"></div>
                  <div className=" absolute right-4 top-0 fade-in-button font-extrabold overflow-x-hidden w-auto h-10 flex transition-all duration-300 ease-in-out justify-center  text-white p-2 rounded-md border-2 border-zinc-500 mt-4 mb-2">
                    {response.result[0][index]}
